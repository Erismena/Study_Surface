...
ff_to_load = [r'PIV_svCloseUpCenterThird_makro100mmzeiss_X0mm_Y15mm_fps2500_A15mm_f05Hz_grid3x4_10cycles_flowfield.npy',
              r'PIV_svCloseUpCenterThird_makro100mmzeiss_X0mm_Y15mm_fps2500_A15mm_f10Hz_grid3x4_10cycles_flowfield.npy',
              r'PIV_svCloseUpBottomThird_makro100mmzeiss_X0mm_Y05mm_fps2500_A15mm_f05Hz_grid3x4_10cycles_flowfield.npy',
              r'PIV_svCloseUpBottomThird_makro100mmzeiss_X0mm_Y05mm_fps2500_A15mm_f10Hz_grid3x4_10cycles_flowfield.npy']
...
dx_middleregions = 0.00024522955934 # m
...
for i in range(4):
    ...
    speed = np.nanmean(np.sqrt(ff_phase_averaged[:,:,:,0]**2+ff_phase_averaged[:,:,:,1]**2),axis=0)
...
for fi in np.arange(423,500,1):
    ...
    ax[0].set_ylabel('Center Third')
    ax[2].set_ylabel('Bottom Third')
    
    plt.show()
    plt.pause(0.2)
    fig.savefig(r'C:\Users\danjr\Documents\Fluids Research\Data\misc\PIV\region_freq_comparison\\'+format(fi,'05')+'.png')
    plt.close(fig)
