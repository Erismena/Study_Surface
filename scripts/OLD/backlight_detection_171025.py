...
parent_folder = r'C:\Users\Luc Deike\Documents\high_speed_data\171028\\'
#cine_filename = r'Backlight_bubble_fps1000_svCenterThird_mz100mm_A00mm_f00Hz_largeNeedle_grid3x4_Cam_20861_Cine1'

dt = 1./500 # [s]
dx = 0.000126336189127 #[m]
#dx_evening_b = 0.000102458962614 # [m] bottom is at .109 m
#dx = dx_evening_b

#bg_image = np.load(parent_folder+'bg_image.npy')


#g = fluids2d.geometry.GeometryScaler(dx=dx,im_shape=(1280,608),origin_pos=(.114,-0.045),origin_units='m')
g = fluids2d.geometry.GeometryScaler(dx=dx,im_shape=(1280,608),origin_pos=(.096,-0.045),origin_units='m')
...
#    first_frames[first_frames==0] = np.nan
    ...
    t = tp.link_df(df_all,50,memory=5,adaptive_stop=10)
