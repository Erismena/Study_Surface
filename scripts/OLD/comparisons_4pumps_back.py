...
case_names = [r'piv_4pumps_back_topDown_sched-tenthOn_T0100ms_fps4000_dur4s',
              r'piv_4pumps_back_topDown_sched-tenthOn_T0250ms_fps4000_dur4s',
              r'piv_4pumps_back_topDown_sched-tenthOn_T0500ms_fps4000_dur4s',
              r'piv_4pumps_back_topDown_sched-fifthOn_T0100ms_fps4000_dur4s',
              r'piv_4pumps_back_topDown_sched-fifthOn_T0250ms_fps4000_dur4s',
              r'piv_4pumps_back_topDown_sched-fifthOn_T0500ms_fps4000_dur4s',]
offsets = [(-256,-256)]*len(case_names)
parent_folders = [r'C:\Users\Luc Deike\highspeed_data\180107\\']*len(case_names)
...
fig.tight_layout()
fig.savefig(figfolder+'back_turb_avgs.pdf')
